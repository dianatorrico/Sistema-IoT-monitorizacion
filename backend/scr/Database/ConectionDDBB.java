...
public class ConectionDDBB
{
    ...
    {
        // Por ejemplo: ver todo lo recibido ordenado por fecha
        return getStatement(con,
            "SELECT * FROM telemetria_dispositivo ORDER BY instante DESC"
        );  	
    }

    public static PreparedStatement SetDataBD(Connection con)
    {
        // Insertar SOLO lo mínimo obligatorio usando 2 parámetros:
        // 1) dispositivo_id
        // 2) instante
        //
        // El json_completo lo ponemos de momento a '{}'::jsonb para probar.
        // Más adelante lo cambiaremos para meter el JSON real.
        String sql =
            "INSERT INTO telemetria_dispositivo " +
            "(dispositivo_id, instante, json_completo) " +
            "VALUES (?, ?, '{}'::jsonb)";
